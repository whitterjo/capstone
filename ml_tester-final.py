...
dataset_22 = Dataset.Tabular.from_delimited_files(path=(datastore, 'numeric_cleaned22.csv'))
dataset_21 = Dataset.Tabular.from_delimited_files(path=(datastore, 'numeric_cleaned21.csv'))
dataset_20 = Dataset.Tabular.from_delimited_files(path=(datastore, 'numeric_cleaned20.csv'))
dataset_19 = Dataset.Tabular.from_delimited_files(path=(datastore, 'numeric_cleaned19.csv'))
dataset_18 = Dataset.Tabular.from_delimited_files(path=(datastore, 'numeric_cleaned18.csv'))
...
xg_best = xgb.XGBClassifier(**best_params)
...
print(f1)
with open('best_params_approval_XG' + str(f1) + '.txt', 'w') as convert_file: 
...
feature_imp_df.to_csv("Feature_Importance_XG_tree" + str(f1) + ".csv")
